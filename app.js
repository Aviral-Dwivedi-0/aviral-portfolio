...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.section-title, .about-text, .about-stats, .timeline-item, .project-card, .skills-list, .activity-card, .contact-content');
